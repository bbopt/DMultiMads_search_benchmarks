...
class L1ZDT4 : public NOMAD::Evaluator
{
  public:
    explicit L1ZDT4(const std::shared_ptr<NOMAD::EvalParameters> &evalParams, const size_t ctype)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB), _n(10), _ctype(ctype)

    {
    }

    ~L1ZDT4() override = default;
    ...
    bool eval_x(NOMAD::EvalPoint &x, const NOMAD::Double &hMax, bool &countEval) const override
    {
        ...
        try
        {
            ...
            const double h = 1.0 - sqrt(f1.todouble() / g);
            f2 = g * h;
...
bool run_pb(size_t ctype)
{
    ...
    try
    {
        ...
        std::string history_name = "L1ZDT4_" + std::to_string(ctype) + "_dmultimads.txt";
        ...
        auto ev = std::make_unique<L1ZDT4>(params->getEvalParams(), ctype);
