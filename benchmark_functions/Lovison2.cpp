...
class Lovison2 : public NOMAD::Evaluator
{
  public:
    explicit Lovison2(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~Lovison2() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "lovison2_dmultimads.txt";
        ...
        auto ev = std::make_unique<Lovison2>(params->getEvalParams());
