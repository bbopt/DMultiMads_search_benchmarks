...
class IKK1 : public NOMAD::Evaluator
{
  public:
    explicit IKK1(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~IKK1() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "IKK1_dmultimads.txt";
        ...
        auto ev = std::make_unique<IKK1>(params->getEvalParams());
