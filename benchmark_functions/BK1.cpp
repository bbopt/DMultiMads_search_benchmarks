...
class BK1 : public NOMAD::Evaluator
{
  public:
    explicit BK1(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~BK1() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "BK1_dmultimads.txt";
        ...
        auto ev = std::make_unique<BK1>(params->getEvalParams());
