...
class Deb512b : public NOMAD::Evaluator
{
    public:
        explicit Deb512b(const std::shared_ptr<NOMAD::EvalParameters>& evalParams)
            : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
        {}

        ~Deb512b() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "Deb512b_dmultimads.txt";
        ...
        auto ev = std::make_unique<Deb512b>(params->getEvalParams());
