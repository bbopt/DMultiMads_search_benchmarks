...
class LRS1 : public NOMAD::Evaluator
{
  public:
    explicit LRS1(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~LRS1() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        NOMAD::ArrayOfDouble lb(n, -50);
        params->setAttributeValue("LOWER_BOUND", lb);

        NOMAD::ArrayOfDouble ub(n, 50);
        ...
        std::string history_name = "LRS1_dmultimads.txt";
        ...
        auto ev = std::make_unique<LRS1>(params->getEvalParams());
