...
class Sch1 : public NOMAD::Evaluator
{
  public:
    explicit Sch1(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~Sch1() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "Sch1_dmultimads.txt";
        ...
        auto ev = std::make_unique<Sch1>(params->getEvalParams());
