...
class Deb512a : public NOMAD::Evaluator
{
    public:
        explicit Deb512a(const std::shared_ptr<NOMAD::EvalParameters>& evalParams)
            : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
        {}

        ~Deb512a() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "Deb512a_dmultimads.txt";
        ...
        auto ev = std::make_unique<Deb512a>(params->getEvalParams());
