...
class Lovison3 : public NOMAD::Evaluator
{
  public:
    explicit Lovison3(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~Lovison3() override = default;
    ...
    bool eval_x(NOMAD::EvalPoint &x, const NOMAD::Double &hMax, bool &countEval) const override
    {
        ...
        try
        {
            ...
            // Objectives
            f1 = -x1 * x1 - x2 * x2;
            f2 = -(x1 - 6.0) * (x1 - 6.0) + (x2 + 0.3) * (x2 + 0.3);
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "lovison3_dmultimads.txt";
        ...
        auto ev = std::make_unique<Lovison3>(params->getEvalParams());
