...
class Jin3 : public NOMAD::Evaluator
{
  public:
    explicit Jin3(const std::shared_ptr<NOMAD::EvalParameters> &evalParams, const size_t n, const size_t ctype)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB), _n(n), _ctype(ctype)
    {
    }

    ~Jin3() override = default;
    ...
    bool eval_x(NOMAD::EvalPoint &x, const NOMAD::Double &hMax, bool &countEval) const override
    {
        ...
        try
        {
            ...
            f2 = g * (1.0 - (f1.todouble() / g) * (f1.todouble() / g));
...
bool run_pb(const size_t n, const size_t ctype)
{
    ...
    try
    {
        ...
        auto ev = std::make_unique<Jin3>(params->getEvalParams(), n, ctype);
