...
class VU1 : public NOMAD::Evaluator
{
  public:
    explicit VU1(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~VU1() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "VU1_dmultimads.txt";
        ...
        auto ev = std::make_unique<VU1>(params->getEvalParams());
