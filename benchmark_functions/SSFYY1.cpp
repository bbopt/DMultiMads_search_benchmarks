...
class SSFYY1 : public NOMAD::Evaluator
{
  public:
    explicit SSFYY1(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~SSFYY1() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "SSFYY1_dmultimads.txt";
        ...
        auto ev = std::make_unique<SSFYY1>(params->getEvalParams());
