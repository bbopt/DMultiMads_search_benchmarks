...
class MHHM1 : public NOMAD::Evaluator
{
    public:
        explicit MHHM1(const std::shared_ptr<NOMAD::EvalParameters>& evalParams)
            : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
        {}

        ~MHHM1() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "MHHM1_dmultimads.txt";
        ...
        auto ev = std::make_unique<MHHM1>(params->getEvalParams());
