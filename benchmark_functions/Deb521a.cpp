...
class Deb521a : public NOMAD::Evaluator
{
    public:
        explicit Deb521a(const std::shared_ptr<NOMAD::EvalParameters>& evalParams)
            : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
        {}

        ~Deb521a() override = default;
        ...
        bool eval_x(NOMAD::EvalPoint& x, const NOMAD::Double& hMax, bool& countEval) const override
        {
            ...
            try
            {
                ...
                const double g = 1 + pow(x2, gamma);
                const double h = 1 - (f1.todouble() / g) * (f1.todouble() / g);
                f2 = g * h;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "Deb521a_dmultimads.txt";
        ...
        auto ev = std::make_unique<Deb521a>(params->getEvalParams());
