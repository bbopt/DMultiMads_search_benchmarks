...
class Deb521b : public NOMAD::Evaluator
{
    public:
        explicit Deb521b(const std::shared_ptr<NOMAD::EvalParameters>& evalParams)
            : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
        {}

        ~Deb521b() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "Deb521b_dmultimads.txt";
        ...
        auto ev = std::make_unique<Deb521b>(params->getEvalParams());
