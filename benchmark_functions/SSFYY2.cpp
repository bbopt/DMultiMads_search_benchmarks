...
class SSFYY2 : public NOMAD::Evaluator
{
  public:
    explicit SSFYY2(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~SSFYY2() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        NOMAD::ArrayOfDouble lb(n, -100);
        params->setAttributeValue("LOWER_BOUND", lb);

        NOMAD::ArrayOfDouble ub(n, 100);
        ...
        std::string history_name = "SSFYY2_dmultimads.txt";
        ...
        auto ev = std::make_unique<SSFYY2>(params->getEvalParams());
