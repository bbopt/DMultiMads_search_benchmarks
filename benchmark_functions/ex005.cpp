...
class Ex005 : public NOMAD::Evaluator
{
    public:
        explicit Ex005(const std::shared_ptr<NOMAD::EvalParameters>& evalParams)
            : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {}

        ~Ex005() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "ex005_dmultimads.txt";
        ...
        auto ev = std::make_unique<Ex005>(params->getEvalParams());
