...
class Lovison1 : public NOMAD::Evaluator
{
  public:
    explicit Lovison1(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~Lovison1() override = default;
    ...
    bool eval_x(NOMAD::EvalPoint &x, const NOMAD::Double &hMax, bool &countEval) const override
    {
        ...
        try
        {
            ...
            // Objectives
            f1 = -1.05 * x1 * x1 - 0.98 * x2 * x2;
            f2 = -0.99 * (x1 - 3) * (x1 - 3) - 1.03 * (x2 - 2.5) * (x2 - 2.5);
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "lovison1_dmultimads.txt";
        ...
        auto ev = std::make_unique<Lovison1>(params->getEvalParams());
