...
class MOP6 : public NOMAD::Evaluator
{
  public:
    explicit MOP6(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~MOP6() override = default;
    ...
    bool eval_x(NOMAD::EvalPoint &x, const NOMAD::Double &hMax, bool &countEval) const override
    {
        ...
        try
        {
            ...
            f1 = x1;
            f2 = (1 + 10 * x2) *
                 (1 - (x1 / (1 + 10 * x2)) * (x1 / (1 + 10 * x2)) - x1 / (1 + 10 * x2) * sin(8 * PI * x1));
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "MOP6_dmultimads.txt";
        ...
        auto ev = std::make_unique<MOP6>(params->getEvalParams());
