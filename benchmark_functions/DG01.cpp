...
class DG01 : public NOMAD::Evaluator
{
    public:
        explicit DG01(const std::shared_ptr<NOMAD::EvalParameters>& evalParams)
            : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
        {}

        ~DG01() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "DG01_dmultimads.txt";
        ...
        auto ev = std::make_unique<DG01>(params->getEvalParams());
