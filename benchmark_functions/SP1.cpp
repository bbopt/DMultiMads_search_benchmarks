...
class SP1 : public NOMAD::Evaluator
{
  public:
    explicit SP1(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~SP1() override = default;
    ...
    bool eval_x(NOMAD::EvalPoint &x, const NOMAD::Double &hMax, bool &countEval) const override
    {
        ...
        try
        {
            ...
            // Objectives
            f1 = (x1 - 1) * (x1 - 1) + (x1 - x2) * (x1 - x2);
            f2 = (x2 - 3) * (x2 - 3) + (x1 - x2) * (x1 - x2);
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "SP1_dmultimads.txt";
        ...
        auto ev = std::make_unique<SP1>(params->getEvalParams());
