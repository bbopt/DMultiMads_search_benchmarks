...
class IM1 : public NOMAD::Evaluator
{
  public:
    explicit IM1(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~IM1() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "IM1_dmultimads.txt";
        ...
        auto ev = std::make_unique<IM1>(params->getEvalParams());
