...
class VU2 : public NOMAD::Evaluator
{
  public:
    explicit VU2(const std::shared_ptr<NOMAD::EvalParameters> &evalParams)
        : NOMAD::Evaluator(evalParams, NOMAD::EvalType::BB)
    {
    }

    ~VU2() override = default;
...
bool run_pb()
{
    ...
    try
    {
        ...
        std::string history_name = "VU2_dmultimads.txt";
        ...
        auto ev = std::make_unique<VU2>(params->getEvalParams());
